...
tools: ['changes', 'search/codebase', 'edit/editFiles', 'fetch', 'findTestFiles', 'githubRepo', 'openSimpleBrowser', 'problems', 'runCommands', 'runTasks', 'search', 'runCommands/terminalLastCommand', 'testFailure', 'usages', 'playwright/*', 'github']
---
