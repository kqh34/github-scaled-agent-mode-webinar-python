...
tools: ['changes', 'search/codebase', 'edit/editFiles', 'fetch', 'findTestFiles', 'githubRepo', 'problems', 'runCommands', 'runTasks', 'search', 'runCommands/terminalLastCommand', 'testFailure', 'usages', 'playwright/*', 'github', 'Azure MCP Server/*']
---
